    ...
    <MainLayout>
      <div className="About container">
        <div className="about-header">
          <h3>Created by NWOS. On the 15th of may 2021</h3>
        </div>
        ...
        <div className="about-body">
          ...
          <div className="about-body-section">
            ...
            <p>
              ...
              LeaderBoard which Helps speedCubers all around the world to
              compete with each other (NOT OFFICIAL).
            </p>

            <div className="about-body-section-subsection">
              <p>
                <span>Torunament: </span>You don’t need to go to a tournament to
                Participate. Although it take away the fun but in this Pandemic
                is better to stay inside as much as possible.
              </p>
              <p>
                <span>Comfort: </span>I believe that anyone can perform more
                efficiently and Consistently in their comfort zone which helps
              ...
              <p>
                ...
                Don’t worry this leaderBoard is 100% legit because in order to
                get into the leaderboard you need to send the video proof of the
                same which will be thoroughly checked by our moderators. And
                then only the leaderboard will be updated.
              </p>
            </div>
          </div>
          ...
          <div className="about-body-section">
            ...
            <div className="about-body-section-subsection">
              <p>
                ...
                whom we trust. They maintain the authenticity of the
                leaderboard. And are in charge of verifying the submitted
                footage are authentic and update the leaderboard.
              </p>
              <p>
          ...
          <div className="about-body-section">
            <p>
              ...
              available and you can contribute to the website and can report a
              bug in the website via the above-mentioned ways.
            </p>
          </div>
          ...
          <div className="about-body-section">
            <p>
              ...
              following ways. I really appreciate everyone who supports me
              without you people this would be almost impossible
            </p>
            <div className="about-body-section-links">
              <a
                // href="https://github.com/somkumarav/cubeSolve"
